...
/* 협업(B2B) — 브랜드·기관 담당자용. /business 와 보는 사람이 아예 다르다.
   ...
   ⚠️ 없는 실적을 쓰지 않는다. 우리가 댈 수 있는 것은 "2015년부터 직영 3곳을 굴려온 것"뿐이다. (연차 표기는 해마다 낡아서 고정 연도로 통일(2026-08-13) → 2026-08-21 사장님 지시로 전부 SINCE 2015 로 변경)
    ...
    <div className="bizsys">
      <section className="bz-hero">
        ...
        <div className="wrap">
          ...
          <p className="sub">
            ...
            2015년부터 강남에서 방탈출 3곳을 직접 만들고 운영하면서 다듬어 온 것입니다.
          </p>
          ...
          <div className="strip">
            <div><b>SINCE 2015</b><span>직접 운영 중</span></div>
      ...
      <div className="wrap">
        ...
        <section className="bz-sec">
          ...
          <div className="trust">
            <div className="reveal"><b>매일 운영합니다</b><span>강남 3곳에서 2015년부터 직접 손님을 받습니다. 주소도 공개돼 있습니다.</span></div>
